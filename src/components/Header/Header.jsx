...
const Header = ({ props: { humanScore, computerScore } }) => {
    return (
        <>
            <main className="header-container hidden lg:flex justify-evenly items-center h-1/5">
            ...
            <main className="header-container flex flex-col lg:hidden justify-evenly items-center h-1/5">
